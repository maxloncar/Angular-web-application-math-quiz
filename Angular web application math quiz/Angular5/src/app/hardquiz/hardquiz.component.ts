...
@Component({
  selector: 'app-hardquiz',
  templateUrl: './hardquiz.component.html',
  styleUrls: ['./hardquiz.component.css']
})
export class HardquizComponent implements OnInit {
  ...
  ngOnInit(){
    if (parseInt(localStorage.getItem('seconds')) > 0){
      ...
      if (this.quizService.qnProgress == 10){
        this.route.navigate(['/hardresult']);
      }
      else{
        this.startTimer();
      }
